    ...
    <main>
        ...
        <div class="dashboard-items">
            <div class="item">
                ...
                <span>Today</span>
                <span class="item-description" id="today"></span>
            </div> 
            <div class="item">
            ...
            <div class="item">
                <i style="font-size:94px" class="fa">&#xf0c0;</i>
                <span class="item-description">All users</span>
            </div>
            <div class="item">
                <i class="material-icons" style="font-size:94px">&#xe871;</i>
                <span class="item-description">Building requests</span>
            </div>
        </div>
    </main>
</body>
